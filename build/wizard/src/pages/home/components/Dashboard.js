...
import SwarmUpload from "./SwarmUpload";
            ...
            <section className="is-medium has-text-white">
                <div className="columns is-mobile">
                    <div className="column is-8-desktop is-10">
                        <h1 className="title is-1 is-spaced has-text-white">Swarm node (BEE)</h1>
                    </div>
                </div>
                <p className="">A node for interacting with the Swarm network</p>
            </section>

            <SwarmInfo session={wampSession} />
            <SwarmUpload/>
